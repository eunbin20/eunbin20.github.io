...
- [1. 함수의 매개변수의 타입 추론 방식](#1-함수의-매개변수의-타입-추론-방식)
- [2. ?으로 표현되는 선택적 매개변수와 | undefined를 포함하는 유니언 타입의 차이](#2-으로-표현되는-선택적-매개변수와--undefined를-포함하는-유니언-타입의-차이)
- [3. 반환 타입으로 void vs undefined vs never](#3-반환-타입으로-void-vs-undefined-vs-never)
- [3-1. never의 또다른 용법: 복잡한 조건 타입 표현하기.](#3-1-never의-또다른-용법-복잡한-조건-타입-표현하기)
- [4. enum을 사용하는 것은 성능면에서 좋지 않다!](#4-enum을-사용하는-것은-성능면에서-좋지-않다)
- [5. 배열은 불안정하다.](#5-배열은-불안정하다)
- [참고](#참고)
